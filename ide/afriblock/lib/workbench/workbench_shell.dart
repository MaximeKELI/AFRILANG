      ...
      child: Row(
        children: [
          ...
          _MenuBtn(label: 'File', items: [
            ...
            _MenuAction('Add Folder to Workspace…', () => promptAddFolderToWorkspace(context)),
          ...
          _MenuBtn(label: 'Edit', items: [
            ...
            _MenuAction('Rename Symbol…', () => promptRenameSymbol(context)),
            _MenuAction('Find References', () => wb.findReferencesAtCaret()),
          ]),
          _MenuBtn(label: 'Run', items: [
            ...
            _MenuAction('Stop Debug', () => wb.stopDebug()),
          ...
          _MenuBtn(label: 'View', items: [
            ...
            _MenuAction('Find References', () => wb.findReferencesAtCaret()),
            _MenuAction('Toggle Blame', () => wb.toggleBlame()),
