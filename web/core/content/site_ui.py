...
UI = {
    'fr': {
        ...
        'stdlib_page': {
            ...
            'lead': 'Parcourez les modules de la bibliothèque standard AFRILANG — core documenté, catalogues expérimentaux à part.',
            ...
            'overview_title': 'À propos',
            'example_title': 'Exemple',
            'source_title': 'Signatures',
            'doc_title': 'Documentation dépôt',
            'fn_role': 'Rôle',
            'no_api': 'Aucune signature listée pour ce module — consultez le guide ou le dépôt.',
            'docs_link': 'Guide stdlib',
            'tests': 'Tests',
        },
        'libraries_page': {
    ...
    'en': {
        ...
        'stdlib_page': {
            ...
            'label': 'Stdlib',
            'h1': 'Stdlib browser',
            'lead': 'Browse AFRILANG standard library modules — documented core, experimental catalogs separately.',
            ...
            'source_title': 'Signatures',
            'doc_title': 'Repo documentation',
            'fn_role': 'Role',
            'no_api': 'No signatures listed for this module — see the guide or the repository.',
            'docs_link': 'Stdlib guide',
            'tests': 'Tests',
        },
        'libraries_page': {
