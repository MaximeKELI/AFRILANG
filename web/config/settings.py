...
if DEBUG and '*' not in ALLOWED_HOSTS:
    # Émulateurs + téléphone physique (IP LAN) pour l’app Flutter
...
MIDDLEWARE = [
    ...
    'core.middleware.mobile_cors.MobileCorsMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.i18n_ui',
            ],
        },
    },
]
...
AFRILANG_BIN = os.environ.get(
    'AFRILANG_BIN',
    str(REPO_ROOT / 'build' / 'afrilang'),
)
AFRILANG_ROOT = os.environ.get('AFRILANG_ROOT', str(REPO_ROOT))
