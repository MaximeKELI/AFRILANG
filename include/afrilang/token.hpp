...
enum class TokenType {
    ...
    TypeNumber, TypeInt, TypeBigInt, TypeText, TypeBool, TypeJson, TypeTensor, TypeOptimizer,
...
inline const char* tokenTypeName(TokenType type) {
    switch (type) {
        ...
        case TokenType::TypeTensor:     return "tensor";
        case TokenType::TypeOptimizer:  return "optimizer";
