...
int main() {
    #line 4 "/home/maxime/AFRILANG/examples/fs_demo.afr"
        #line 5 "/home/maxime/AFRILANG/examples/fs_demo.afr"
        #line 7 "/home/maxime/AFRILANG/examples/fs_demo.afr"
    std::string dir = "/tmp/afrilang_fs_demo";
    #line 11 "/home/maxime/AFRILANG/examples/fs_demo.afr"
    if ((io::fileExists(dir) == true)) {
        #line 10 "/home/maxime/AFRILANG/examples/fs_demo.afr"
        fs::removeFile((dir + "/sample.txt"));
    }
    #line 13 "/home/maxime/AFRILANG/examples/fs_demo.afr"
    std::cout << fs::makeDir(dir) << std::endl;
    #line 14 "/home/maxime/AFRILANG/examples/fs_demo.afr"
    io::writeFile((dir + "/sample.txt"), "filesystem demo");
    #line 16 "/home/maxime/AFRILANG/examples/fs_demo.afr"
    std::cout << fs::fileSize((dir + "/sample.txt")) << std::endl;
    #line 18 "/home/maxime/AFRILANG/examples/fs_demo.afr"
    for (auto& name : fs::listDir(dir)) {
        #line 19 "/home/maxime/AFRILANG/examples/fs_demo.afr"
        std::cout << name << std::endl;
    }
    #line 22 "/home/maxime/AFRILANG/examples/fs_demo.afr"
