...
int main() {
    #line 1 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::function<double(double)> doubleIt = [&](double x) -> double {
    #line 2 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    return (x * 2LL);
    };
    #line 5 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::function<double(double)> addFive = [&](double x) -> double {
    #line 6 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    return (x + 5LL);
    };
    #line 9 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::cout << doubleIt(21LL) << std::endl;
    #line 10 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::cout << addFive(10LL) << std::endl;
    #line 16 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::cout << afr_apply(doubleIt, 10LL) << std::endl;
    #line 17 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::cout << afr_apply(addFive, 100LL) << std::endl;
    ...
    std::cout << pipeline(3LL) << std::endl;
    #line 25 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::function<std::string(std::string)> greet = [&](std::string name) -> std::string {
    #line 26 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    return ("Hello, " + name);
    };
    #line 29 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::cout << greet("AFRILANG") << std::endl;
    #line 31 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::function<double(std::function<double(double)>, double)> runTwice = [&](std::function<double(double)> fn, double x) -> double {
    #line 32 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    return fn(fn(x));
    };
    #line 35 "/home/maxime/AFRILANG/build/../examples/lambdas.afr"
    std::cout << runTwice(doubleIt, 2LL) << std::endl;
    return 0;
}
