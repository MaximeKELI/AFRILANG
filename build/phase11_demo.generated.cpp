...
public:
    ...
    virtual void speak() {
        #line 3 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        std::cout << "..." << std::endl;
    }
...
public:
    ...
    virtual void speak() override {
        #line 9 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
...
public:
    ...
    Box(const T& v) {
        #line 17 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        data = v;
    }

    virtual T get() {
        #line 21 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        return data;
    }
...
public:
    virtual ~AppConfig() {
        #line 34 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    ...
    AppConfig(std::string t) {
        #line 30 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        setTitle(t);
    }
...
int main(int argc, char** argv) {
    ...
    #line 52 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    return ((acc + w) + "-");
    }, "");
    #line 55 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    std::cout << joined << std::endl;
    #line 57 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    std::vector<std::unique_ptr<Animal>> pets;
    pets.push_back(std::unique_ptr<Animal>(std::make_unique<Dog>()));
    pets.push_back(std::unique_ptr<Animal>(std::make_unique<Dog>()));
    #line 59 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    for (auto& _afr_ptr : pets) {
        auto& pet = *_afr_ptr;
        #line 60 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        pet.speak();
    }
    ...
    #line 67 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    std::cout << cfg->getTitle() << std::endl;
    #line 71 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        #line 72 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
        #line 74 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    std::cout << args::count() << std::endl;
    #line 75 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
    std::cout << path::join("examples", "phase11_demo.afr") << std::endl;
    #line 77 "/home/maxime/AFRILANG/build/../examples/phase11_demo.afr"
