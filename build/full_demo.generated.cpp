...
int main() {
    #line 9 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
        #line 11 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
    bool active = true;
    #line 17 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
    if ((active == true)) {
        #line 14 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
        std::cout << "System active" << std::endl;
    } else {
        #line 16 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
        std::cout << "System inactive" << std::endl;
    }
    #line 19 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
    double counter = 0;
    #line 23 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
    while ((counter < 3)) {
        #line 21 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
        std::cout << Utils::twice(counter) << std::endl;
        #line 22 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
        counter = (counter + 1);
    }
    ...
    for (auto& item : items) {
        ...
        if ((item == 2)) {
            #line 28 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
            break;
        }
        #line 30 "/home/maxime/AFRILANG/build/../examples/full_demo.afr"
